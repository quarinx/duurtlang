 ...
 * simulateboard.js
 * 
 * This file contains a function that can be used to convert a board to
 * an SVG. If run instead of the update_ble function, it can be used
...
function get_svg(board) {
    ...
    for(var tileid = 0; tileid < board.tiles.length; tileid++) {
        ...
        var fontfill = '#000000';
        if(red_tiles.includes(tile.number)) {
            fontfill = '#FF8080';
        }
        ...
        svgdata += '      <text\n         id="number ' + tileid + '"\n         xml:space="preserve"\n         style="font-style:normal;font-weight:normal;font-size:40px;line-height:125%;font-family:Sans;letter-spacing:0px;word-spacing:0px;fill: ' + fontfill + ';fill-opacity:1;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"\n         x="65.0"\n         y="110.0">\n';
